...
<form action ="" method ="POST">   
  <h3> <?php echo $username;?>! You can update your profile using the below form: </h3>
    ...
    <?php foreach ($result as $userdetails): ?>
	 ...
	 <td><label for="username">Username : </label></td>
		...
		<tr>		
	 <td><label for="Password">Password(retype old or provide new) : </label></td>
				<td><input class="inputStyle type="text" id="password" name="password"  placeholder="Password"/></td>
		</tr>
